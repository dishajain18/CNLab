...
int main()
{
	...
	address.sin_addr.s_addr = inet_addr("172.16.48.122"); // Server's IP address
	...
	// Here address is socket address of server and sockfd is file descriptor returned while creating the
	socket.
	if (result == -1) {
